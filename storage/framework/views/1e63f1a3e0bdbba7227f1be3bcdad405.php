...
<title><?php echo $__env->yieldContent('title', 'QMMC GSS'); ?> — QMMC General Services</title>
<style>
/* ─── Reset & base ─────────────────────────────────────── */
...
<div class="shell">
  ...
  <aside class="sidebar" id="sidebar">
    ...
    <?php if(auth()->guard()->check()): ?>
      <?php if(auth()->user()->isAdmin()): ?>
        <div class="sidebar-section">
          ...
          <nav class="sidebar-nav">
            ...
            <a href="<?php echo e(route('admin.janitors.index')); ?>"
               class="<?php echo e(request()->routeIs('admin.janitors.*') ? 'active' : ''); ?>">
              <svg class="icon" viewBox="0 0 16 16" fill="currentColor"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm5 6H3a5 5 0 0 1 10 0z"/></svg>
              Janitors
            </a>
            <a href="<?php echo e(route('admin.evaluations.index')); ?>"
               class="<?php echo e(request()->routeIs('admin.evaluations.*') ? 'active' : ''); ?>">
            ...
            <a href="<?php echo e(route('admin.assignments.index')); ?>"
               class="<?php echo e(request()->routeIs('admin.assignments.*') ? 'active' : ''); ?>">
      ...
      <?php elseif(auth()->user()->isEvaluator()): ?>
        <div class="sidebar-section">
          <div class="sidebar-section-label">Evaluator</div>
          <nav class="sidebar-nav">
            <a href="<?php echo e(route('evaluator.dashboard')); ?>"
               class="<?php echo e(request()->routeIs('evaluator.dashboard') ? 'active' : ''); ?>">
              <svg class="icon" viewBox="0 0 16 16" fill="currentColor"><path d="M8 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm5 6H3a5 5 0 0 1 10 0z"/></svg>
              My Janitors
            </a>
            <a href="<?php echo e(route('evaluator.history')); ?>"
               class="<?php echo e(request()->routeIs('evaluator.history') ? 'active' : ''); ?>">
      ...
      <?php elseif(auth()->user()->isJanitor()): ?>
        <div class="sidebar-section">
          <div class="sidebar-section-label">My Portal</div>
          <nav class="sidebar-nav">
            <a href="<?php echo e(route('janitor.dashboard')); ?>"
               class="<?php echo e(request()->routeIs('janitor.dashboard') ? 'active' : ''); ?>">
              <svg class="icon" viewBox="0 0 16 16" fill="currentColor"><path d="M2 2h5v6H2V2zm7 0h5v4H9V2zM2 10h5v4H2v-4zm7 2h5v2H9v-2z"/></svg>
              Dashboard
            </a>
            <a href="<?php echo e(route('janitor.history')); ?>"
               class="<?php echo e(request()->routeIs('janitor.history') ? 'active' : ''); ?>">
    ...
    <div class="sidebar-footer">
      ...
      <div class="user-card">
        ...
        <div class="info">
          ...
          <div class="urole"><?php echo e(auth()->user()->role->name); ?></div>
        </div>
...
</html><?php /**PATH C:\qmmc_laravel\qmmc_laravel\resources\views/layouts/app.blade.php ENDPATH**/ ?>